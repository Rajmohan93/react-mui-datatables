    ...
    render() {
        const columns = [
            {
                ...
                options: {
                    ...
                    // if the below value is set, these values will be used every time the table is
                    // rendered. it's best to let the table internally manage the filterList
                    // filterList: [25, 50],
                        ...
                        display: (filterList, onChange, index, column) => (
                            <div>
                                ...
                                <FormGroup row>
                                    ...
                                    onChange = {
                                        (event) => this.setState({ageFilterChecked: event.target.checked})
                                    } />}
                ...
                options: {
                    ...
                    filterOptions: {
                        names: [
                            "Lower wages", "Average wages", "Higher wages"
                        ],
                        logic(salary, filterVal) {
                            salary = salary.replace(/[^\d]/g, "");
                            const show = (filterVal.indexOf("Lower wages") >= 0 && salary < 100000) || (filterVal.indexOf("Average wages") >= 0 && salary >= 100000 && salary < 200000) || (filterVal.indexOf("Higher wages") >= 0 && salary >= 200000);
                            return !show;
                        }
                    },
                    sort: false
        ...
        const options = {
            ...
            setFilterChipProps: (colIndex, colName, data) => {
                ...
                return {color: "primary", variant: "outlined", className: "testClass123"};
            }
        };
